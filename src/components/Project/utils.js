const projectsModal = [
  ...
  },
  {
    title: "Kajah Ecopack",
    summary:
      "A simple static site developement for my client rajah groups.",
    description: {
  ...
  },
  {
    ...
    summary:
      "This is a simple e-commerce site developed using .NET.",
    description:{
        one: "It consists od three layers social page, e-commerce page and news page. According to your information from your social  page there will be random images will be displayed.",
        two: "If you click any one of the images  it will redirect to the e-commerce page where you can purchase it. And finally in the news page few information about your location will be dispalyed."
    },
